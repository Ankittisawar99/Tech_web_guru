...
$hash = password_hash($logpass,PASSWORD_DEFAULT);
    // $check = "SELECT * FROM `data` WHERE email='$logemail' AND password='$hash'";
      $check = "SELECT * FROM `data` WHERE email='$logemail'";
          ...
          LOGIN
                                    ...
                                    <form class="dropdown-menu p-4" method= 'post'>
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" name="logemail" id="exampleDropdownFormEmail2" placeholder="email@example.com"required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleDropdownFormPassword2" class="form-label">Password</label>
                                            <input type="password" class="form-control" name="logpass" id="exampleDropdownFormPassword2" placeholder="Password"required>
                                        </div>
                                        <div class="mb-3">
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="dropdownCheck2" required>
...
if(isset($_POST["name"],$_POST["number"],$_POST["email"],$_POST["Password"])){
   ...
   $result = mysqli_query($conn, $check);
   if (mysqli_num_rows($result) > 0) {
    echo "<script>alert ('this email is alredy register please choose other email'); window.location ='index.php';</script>";
   exit;
}else{
    $sql = "INSERT INTO `data` (`SNO`, `name`, `email`, `number`, `password`, `Time`) VALUES (NULL, '$name', '$email', '$number', '$hash', current_timestamp())";
    $result = mysqli_query($conn, $sql);

    if ($result) {
        echo "<script>alert ('signup successful'); window.location ='index.php';</script>";
}else echo "<script>alert ('signup not  successful');</script>";}}}
?>
                                            <form action="index.php" method="post">
                                                <div class="mb-3">
                                                    <label for="Formname" class="form-label">Name</label>
                                                    <input type="text" class="form-control" name="name" id="Formname" placeholder="Enter Your Name" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="Formnumber" class="form-label">Number</label>
                                                    <input type="number" class="form-control" id="Formnumber" name="number" placeholder="Enter Your Number" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="FormEmail2" class="form-label">Email address</label>
                                                    <input type="email" class="form-control" id="FormEmail2" name="email" placeholder="email@example.com" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="FormPassword2" class="form-label">Password</label>
                                                    <input type="password" class="form-control" id="FormPassword2" name="Password" placeholder="Password" required>
                                                </div>
                                                <div class="mb-3">
                                                    <div class="form-check">
    ...
    <section>
        ...
        <div class="row">
            <div class="col-4 col-sm-6 text-center">
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/pngwing.com (1).png"></div>
                <hr>
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/pngwing.com (3).png"></div>
                <hr>
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/pngwing.com (2).png"></div>
                <hr>
            </div>
            <div class="col-4 col-sm-6  text-center">
                <div class="hi m-2 mt-5">
                    <h5 class="m-1  mb-1 d-flex  justify-content-center"><mark>HTML</h5>
                    <p class=" m-1 d-flex  justify-content-center">intermediate in html coding</p>
                    
                </div>
                <div class="hi m-2 mt-5">
                    <h5 class="m-1 active mb-1 d-flex  justify-content-center"><mark>CSS</h5>
                    <p class="m-1  d-flex  justify-content-center">intermediate in CSS coding</p>
                  
                </div>
                <div class="hi m-2 mt-5">
                    <h5 class="m-1 mb-1 d-flex  justify-content-center"><mark>JAVASCRIPT</h5>
                    <p class="m-1 d-flex  justify-content-center">intermediate in JAVASCRIPT coding</p>
    ...
    <div class="row">
    <div class="col-4 col-sm-6  text-center">
                <div class="box m-2 mt-3 mx-3  d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/pngegg (1).png"></div>
                <hr>
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/pngegg (3).png"></div>
                <hr>
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/pngegg (4).png"></div>
                <hr>
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/1-2-php-logo-free-download-png.png"></div>
                <hr>
                <div class="box m-2 mt-3 mx-3 d-flex  justify-content-center" id="com"><img class="img-fluid" src="./imsgrs/2-2-wordpress-logo-png-hd.png"></div>
                <hr>
            </div>
            <div class="col-4 col-sm-6 text-center">
                <div class="hi m-2 mt-5">
                    <h5 class="m-1 mb-1 d-flex  justify-content-center"><mark>BOOTSTRAP</h5>
                    <p class="m-1 d-flex  justify-content-center">intermediate in BOOTSTRAP coding</p>
                    
                </div>
                <div class="hi m-2 mt-5">
                    <h5 class="m-1 mb-1 d-flex  justify-content-center"><mark>C</h5>
                    <p class="m-1 d-flex  justify-content-center">intermediate in C coding</p>
                ...
                <div class="hi m-2 mt-4">
                    <h5 class="m-1 mb-1 d-flex  justify-content-center"><mark>Core PHP</h5>
                    <p class="m-1 d-flex  justify-content-center">intermediate in Core PHP coding</p>
                    
                </div>
                <div class="hi m-2 mt-4">
                    <h5 class="m-1  mb-1 d-flex  justify-content-center"><mark>Wordpress</h5>
                    <p class="m-1 d-flex  justify-content-center">intermediate in Wordpress </p>
